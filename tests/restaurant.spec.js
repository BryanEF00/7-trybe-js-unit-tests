...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    const objectMenu = createMenu('objetoQualquer');
    objectMenu.order('coxinha');

    expect(objectMenu.consumption).toEqual(['coxinha']);
    ...
    // ```
    const objectMenu1 = createMenu('objetoQualquer');

    objectMenu1.order('coxinha');
    objectMenu1.order('agua');
    objectMenu1.order('sopa');
    objectMenu1.order('sashimi');

    expect(objectMenu1.consumption).toEqual([
      'coxinha',
      'agua',
      'sopa',
      'sashimi',
    ...
    // ```
    const objectMenu2 = createMenu('objetoQualquer');

    objectMenu2.order('coxinha');
    objectMenu2.order('agua');
    objectMenu2.order('coxinha');

    expect(objectMenu2.consumption).toEqual(['coxinha', 'agua', 'coxinha']);
    ...
    const objectMenu3 = createMenu(menu);

    objectMenu3.order('coxinha');
    objectMenu3.order('agua');
    objectMenu3.order('coxinha');

    expect(objectMenu3.pay()).toBeCloseTo(12.87);
